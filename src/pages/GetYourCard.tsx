...
const GetYourCard: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Form data to be sent to body.hamed@outlook.com:', formData);
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Thank you for choosing Payless! We've received your card request and will contact you within 24 hours to activate your discount card.
            </p>
