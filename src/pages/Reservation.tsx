...
const Reservation: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.idSerial.trim()) {
      newErrors.idSerial = 'Payless Card ID is required';
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate form submission to body.hamed@outlook.com
    try {
      // In a real implementation, you would send this data to your backend
      console.log('Reservation data to be sent to body.hamed@outlook.com:', formData);
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Thank you for your reservation request! We've received your booking details and will contact you within 24 hours to confirm your reservation.
            </p>
            ...
            <div className="bg-sky-50 border border-sky-200 rounded-lg p-6 mb-8">
              ...
              <div className="space-y-2 text-sm text-gray-600 text-left">
                <div className="flex items-center space-x-2">
                  ...
                  <span>We'll verify your Payless card membership</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-sky-500 rounded-full"></div>
                  <span>Your reservation will be processed within 24 hours</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-sky-500 rounded-full"></div>
                  <span>You'll receive confirmation with your discount applied</span>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-4">
            Specify your registered phone number & your membership ID - Make sure to put your data accurately
          </p>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Up to 20% off with your Payless card</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Confirmation within 24 hours</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Dedicated support for members</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <p className="text-sm text-gray-500 text-center">
                  Exclusive reservations for Payless cardholders
                </p>
              </div>
            </div>
          </div>
